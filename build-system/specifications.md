...
Each system has an [OS_CLASS]{.title-ref} definition in its
...
> PROD_HOST = aaa PROD_IOC = bbb PROD = ccc
...
> DBD += <name>.dbd <name>_DBD += <file1>.dbd <file2>.dbd ...
...
> c++ compiler options.
>
> <name>_[CXXFLAGS]()<osclass> += <c++ flags>
>
> c++ compiler options for the specified osclass.
>
...
> have a [SCRIPTS_HOST]()<osclass> definition
...
> have a [PROD_IOC]()<osclass> definition
>
> PROD_HOST += <name>
>
...
> CONFIG_ADDONS
>
> Definitions which setup the variables that have <osclass> and
> DEFAULT options.
>
> CONFIG_APP_INCLUDE
>
...
:   Describes how to modify a R3.14.0alpha1 application so that it
    builds with release R3.14.0beta1.
...
:   Describes how to modify a R3.14.* application so that it builds
    with next release after R3.14.*.
...
:   WIN32 bat file to set path and environment variables for building
    with cygwin gcc/g++ compilers

win32.bat

:   WIN32 bat file to set path and environment variables for building
    with MS Visual C++ compilers
